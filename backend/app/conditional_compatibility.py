...
def check_conditional_compatibility(fish1: Dict[str, Any], fish2: Dict[str, Any]) -> Tuple[str, List[str], List[str]]:
    ...
    # Rule 0: Handle special case fish with nuanced compatibility requirements
    ...
    # Rule 2: Size Difference (Conditional based on temperament)
    try:
    ...
    # Rule 3: Temperament Compatibility
    if temp1_score == 2 and temp2_score == 0:
        ...
        # Semi-aggressive with peaceful - conditional
    ...
    # Rule 4: Social Behavior Compatibility
    ...
    # Rule 5: pH Compatibility (Conditional for minor differences)
    try:
    ...
    # Rule 6: Temperature Compatibility (Conditional for minor differences)
    try:
    ...
    # Rule 7: Tank Size Requirements (Conditional for large fish)
    try:
    ...
    # Rule 8: Diet-based Considerations
